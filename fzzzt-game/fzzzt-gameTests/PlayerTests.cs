...
namespace fzzzt_game.Tests
{
    ...
    public class PlayerTests
    {
        ...
        public void Should_Get_Total_Point_Value_All_Cards()
        {
            ...
            player.CardsInHand.Add(new RobotCard(null, 1, 2, 1, null));
            player.CardsInBid.Add(new RobotCard(null, 1, 2, 1, null));
            player.CardsInBid.Add(new RobotCard(null, 1, 2, 1, null));
            player.CardsInBid.Add(new RobotCard(null, 1, 2, 1, null));
            player.DiscardPile.Add(new RobotCard(null, 1, 2, 1, null));
            ...
            player.Widgets.Add(new Widget
            {
                ...
                RobotCards = new List<Card> { new RobotCard(null, 1, 3, 1, null) }
            });
            
            int autual = player.GetTotalScore();

            Assert.AreEqual(14, autual);
        }
    }
}